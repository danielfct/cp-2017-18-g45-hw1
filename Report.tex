...
\section{Avaliação}
Como se pode verificar no gráfico da figura 1, houve um aumento de velocidade na execução do código em cerca de 3x. 
É um máximo esperado, visto que existe uma parte sequencial do programa que não pode ser paralelizada, sendo que este troço corresponde a uma grande parte do runtime.
Como tal correr o programa utilizando mais processadores que 8/12 TODO não iria trazer grandes benefícios na velocidade.
